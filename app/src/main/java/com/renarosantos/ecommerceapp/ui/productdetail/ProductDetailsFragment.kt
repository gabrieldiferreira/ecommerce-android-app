package com.renarosantos.ecommerceapp.ui.productdetail
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            Glide.with(requireContext())
                .load(
                    "https://firebasestorage.googleapis.com/v0/b/androidecommercesample.appspot.com" +
                            "/o/playstation_1.png?alt=media&token=1414f40e-23cf-4f44-b922-e12bfcfca9f3"
                )
                .into(viewProductImage)
            binding.viewPrice.text = "250 US$"
            binding.viewFullDescription.text =
                "The PlayStation 3 (PS3) is a home video game console developed by Sony Computer " +
